...
import 'package:cleanarchitecture/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
void main(){
  ...
  group('getConcreteNumberTrivia', (){
   ...
   runTestsOnline(() {
        ...
        test('should cache the data locally when the call to remote data '
   ...
   runTestsOffline((){
      ...
      test('should return last locally cached data when the cached data is '
          'present', () async {
        when(mockLocalDataSource.getLastNumberTrivia()).thenAnswer((_) async =>
            tNumberTriviaModel);
  ...
  //separation between getConcreteNumberTrivia & getRandomNumberTrivia
